    ...
    <div className="min-h-screen bg-slate-950 p-8 text-slate-100">
      <div className="mx-auto max-w-5xl space-y-8">
        <div className="flex items-center justify-between rounded-[32px] border border-slate-800 bg-slate-900/90 p-8 shadow-2xl">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-cyan-300">Parent Portal</p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-[32px] border border-slate-800 bg-slate-900/90 p-8 shadow-xl">
            <h3 className="text-xl font-semibold text-white">My Children</h3>
            <p className="mt-2 text-slate-400">View progress and attendance.</p>
          </div>
          <div className="rounded-[32px] border border-slate-800 bg-slate-900/90 p-8 shadow-xl">
            <h3 className="text-xl font-semibold text-white">Fee Payments</h3>
            <p className="mt-2 text-slate-400">Pay tuition fees online.</p>
          </div>
          <div className="rounded-[32px] border border-slate-800 bg-slate-900/90 p-8 shadow-xl">
            <h3 className="text-xl font-semibold text-white">Announcements</h3>
            <p className="mt-2 text-slate-400">Latest news from academy.</p>
          </div>
        </div>
      </div>
    </div>
